      ...
      <div className={`${theme === "dark" ? "bg-[#1c1b29]" : "bg-white"} p-4 rounded-lg`}>
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="relative h-10 w-72">
            <input
              className="peer h-full w-full rounded-[7px] border border-orange-300 bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-100 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-teal-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
              placeholder=" "
            />
