    ...
    <div className="rounded-xl bg-gray-800 bg-opacity-50 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8">
        ...
        <form action="#">
            <div className="mb-4 text-lg">
                <input className="bg-black border-cyan-400 rounded-3xl border-none bg-opacity-50 px-6 py-2 text-center text-inherit placeholder-gray-300 shadow-lg outline-none backdrop-blur-md w-full" type="text" name="name" placeholder="@Email" />
            </div>
